...
const Swap = () => {
    ...
    return (
        <Container>
            ...
            />
            <SafeMoonWarningModal isOpen={transactionWarning.selectedToken === 'SAFEMOON'}
                                  onConfirm={handleConfirmWarning}/>
            <CardNav/>
            <AppBody>
                                    ...
                                    <AutoColumn gap="4px">
                                        ...
                                        {allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (
                                            <RowBetween align="center" style={{padding:'0 0 20px 0'}}>
                                                <Text fontSize="17px">{TranslateString(88, 'Slippage Tolerance')}</Text>
                        ...
                        <BottomGrouping>
                            {!account ? (
                                ...
                                <GreyCard style={{textAlign: 'center',borderRadius:'5px'}}>
                                    <Text style={{color:'#fff',fontFamily:'alibaba-puhuiti, sans-serif',fontWeight:600}}
